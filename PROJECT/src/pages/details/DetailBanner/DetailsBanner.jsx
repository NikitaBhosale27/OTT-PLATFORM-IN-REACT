          ...
          {!!data && <>
            <div>
              <div className="backdrop-img">
                <Img src={url.backdrop + data.backdrop_path} alt="movie poster img" />
              </div>
            </div>
            ...
            <ContentWrapper>
              <div className="content">
                <div className="left">
                  {data.poster_path ? <Img src={url.backdrop + data.poster_path} className="posterImg" alt="poster img" /> : <Img src={PosterFallback} className="posterImg" alt="poster img" />}
                </div>
